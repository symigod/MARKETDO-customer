...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  void addToFavorites() {
    ...
    if (isFavorite) {
      favoritesCollection.doc(favoriteDocumentId).delete().then((value) {
  ...
  addToCart(String customerID, String productID) async {
    // try {
    //   final newCart = _firestore.collection('carts').doc();
